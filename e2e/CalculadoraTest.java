...
public class CalculadoraTest {
  ...
  public void calculadora() {
    driver.get("http://host.docker.internal:8181/calculadora");
    ...
    assertThat(driver.findElement(By.id("txtPantalla")).getText(), is("-987456,0123"));
    driver.findElement(By.id("btnBorrar")).click();
    assertThat(driver.findElement(By.id("txtPantalla")).getText(), is("-987456,012"));
    ...
    assertThat(driver.findElement(By.id("txtResumen")).getText(), is("1 +"));
    driver.findElement(By.cssSelector(".btnDigito:nth-child(15)")).click();
    {
      WebElement element = driver.findElement(By.cssSelector(".btnOperar:nth-child(9)"));
    ...
    assertThat(driver.findElement(By.id("txtResumen")).getText(), is("2 *"));
    driver.findElement(By.cssSelector(".btnDigito:nth-child(16)")).click();
    ...
    assertThat(driver.findElement(By.id("txtResumen")).getText(), is("6 /"));
    driver.findElement(By.cssSelector(".btnDigito:nth-child(19)")).click();
    driver.findElement(By.cssSelector(".btnOperar:nth-child(21)")).click();
    assertThat(driver.findElement(By.id("txtPantalla")).getText(), is("Infinity"));
  }
}
